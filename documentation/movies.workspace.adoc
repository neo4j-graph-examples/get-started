...
You already have two indexes because of the constaints created in the beginning of the `MERGE` statement, see link:https://neo4j.com/docs/cypher-manual/current/constraints/[Cypher Manual -> Constraints^] for more information.

You may be interested in both the year people were born and the year movies were released.
