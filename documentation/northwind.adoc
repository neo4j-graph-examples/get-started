...
Click the link below to download a zip file with the CSV files and an initial graph model prepared for you. Once saved to your computer you can use the data importer to upload it.

https://neo4j-graph-examples.github.com/get-started/data/northwind-data-importer-model-data.zip[Download Northwind sample data zip file^]
