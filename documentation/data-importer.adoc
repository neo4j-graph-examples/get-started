...
You can't modify the two that are created for you, but you can add additional indexes.
...
Only the properties you mapped from the _Definition_ tab are available.
...
See if you can add an index that will help you that!
