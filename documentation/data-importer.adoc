...
:northwind-full-zip-file: http://localhost:8000/data/northwind-full.zip
...
button::Load the full Northwind dataset[role=NX_IMPORT_LOAD,endpoint={northwind-full-zip-file}]
