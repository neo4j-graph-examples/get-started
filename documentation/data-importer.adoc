...
To see the import results again once you've closed the window, click highlight:import/import-show-results[Show results].
...
If you click the highlight:explore/searchBoxPlaceholder[search bar] in the top left corner, it gets populated with _Show me a graph_.
